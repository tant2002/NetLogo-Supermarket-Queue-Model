...
The parameter determine whenever customer can or cannot use sco-servers. Customers with basket size that exceed the value of the parameter are refered to the service checkouts (servers). Only if none of service checkout is open,  customers with basket size that exceed thershold are refered to sco-servers.     
